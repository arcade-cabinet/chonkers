...
const GOVERNOR_RUNS = Number.parseInt(
	process.env.GOVERNOR_RUNS ?? "3",
	10,
);
...
test.describe(
	"governor — N AI-vs-AI matches drive the full visual stack",
	{ tag: "@governor" },
	() => {
		test(
			`runs ${GOVERNOR_RUNS} AI-vs-AI matches via the testHook`,
			async ({ page }) => {
